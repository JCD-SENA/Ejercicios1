...
public class EjercicioCristian14052024 {
    public static void main(String[] args) {
        int codMenuPpal=0, cantPlatos=0, cantPlatosTipicos=0, cantPlatosInternacionales=0, cantPlatosCarta=0;
        float precioTotal = 0;
        final float PRECIO_PLATO_TIPICO = 12000, PRECIO_PLATO_CARTA = 8000, PRECIO_PLATO_INTERNACIONAL = 20000;
        ...
        do {
            ...
            switch (codMenuPpal) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    JOptionPane.showMessageDialog(null, "Se ha solicitado un börek, el costo es $"+PRECIO_PLATO_INTERNACIONAL);
